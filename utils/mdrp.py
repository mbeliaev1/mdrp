...
class mdrp_prob:
    ...
    def __init__(self, prob_setup):
        ...
        self.n_orders = self.s_time.shape[0]
        self.n_modes = self.s_time.shape[1]
    ...
    def get_bounds(self,):
        ...
        cu[1+self.n_modes:1+self.n_modes+self.n_orders] = 1
        cl[1+self.n_modes:1+self.n_modes+self.n_orders] = 1
    ...
    def guess_init(self):
        x = np.ones(self.n_orders*self.n_modes)/self.n_modes
        return x
    ...
    def objective(self, x):
        ...
        return np.inner(lat,x)/self.n_orders
